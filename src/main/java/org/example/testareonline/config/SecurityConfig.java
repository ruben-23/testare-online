package org.example.testareonline.config;


import lombok.AllArgsConstructor;
import org.example.testareonline.entity.Role;
import org.example.testareonline.filters.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain configure(HttpSecurity http, CorsConfigurationSource corsConfigurationSource) throws Exception {
        http
                ...
                .authorizeHttpRequests(c -> c
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/teste/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/domenii/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/intrebari/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/optini/**").permitAll()
